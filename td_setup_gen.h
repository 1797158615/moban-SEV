...
class td_setup_gen_class
{
 ...
 public:
  ...
  void generate_td_setup(ostream &stream, unsigned int indent = 0)
  {
    ...
    stream << "\n";
    stream << indent_str;
    stream << "    virt-customize -a \"$PWD_DIR/tdx/guest-tools/image/centos.qcow2\" --upload \"$PWD_DIR/";
    stream << taname;
    stream << ":/home/tdx/\"";
    stream << "\n";
    stream << indent_str;
    ...
    stream << "\n";
    stream << indent_str;
    stream << "    virt-customize -a \"$PWD_DIR/tdx/guest-tools/image/centos.qcow2\" --upload \"$PWD_DIR/$FILE_NAME:$INTERNAL_PATH\"";
    stream << "\n";
    stream << indent_str;
    stream << "    if [ $? -ne 0 ]; then";
    stream << "\n";
