...
class td_setup_gen_class
{
 ...
 public:
  ...
  void generate_td_setup(ostream &stream, unsigned int indent = 0)
  {
    ...
    stream << "\n";
    stream << indent_str;
    stream << "    sudo: ALL=(ALL) NOPASSWD:ALL";
    stream << "\n";
    stream << indent_str;
    stream << "    lock_passwd: false";
    stream << "\n";
    stream << indent_str;
    stream << "    passwd: \\$6\\$rounds=4096\\$salt\\$5BZhkL7J94TqY.BuJY7H3E5u5Jv/0v8bQ1JxK8WzJmWlW6sXo1rX6zvZU6jL6dX6sX0jL6dX6sX0jL6dX6sX0";
    stream << "\n";
    stream << indent_str;
    ...
    stream << "\n";
    stream << indent_str;
    stream << "ssh_pwauth: true";
    stream << "\n";
    stream << indent_str;
    stream << "write_files:";
    stream << "\n";
    stream << indent_str;
    stream << "  - path: /etc/ssh/sshd_config.d/99-custom.conf";
    stream << "\n";
    stream << indent_str;
    stream << "    content: |";
    stream << "\n";
    stream << indent_str;
    stream << "      PasswordAuthentication yes";
    stream << "\n";
    stream << indent_str;
    stream << "      PermitRootLogin yes";
    stream << "\n";
    stream << indent_str;
    stream << "runcmd:";
    stream << "\n";
    stream << indent_str;
    stream << "  - systemctl restart sshd";
    stream << "\n";
    stream << indent_str;
    stream << "EOF";
    stream << "\n";
    ...
    stream << "\n";
    stream << indent_str;
    stream << "  echo \"instance-id: sev-demo\" > meta-data";
    stream << "\n";
    stream << indent_str;
    stream << "  echo \"local-hostname: sev-guest\" >> meta-data";
    stream << "\n";
    stream << indent_str;
    stream << "  genisoimage -output cloud-init.iso -volid cidata -joliet -rock user-data meta-data";
    stream << "\n";
    stream << indent_str;
    stream << "  sudo virt-customize -a ubuntu-sev.qcow2 --root-password password:123456";
    stream << "\n";
    stream << indent_str;
    ...
    stream << "\n";
    stream << indent_str;
    stream << "    -drive file=\"cloud-init.iso\",media=cdrom \\";
    stream << "\n";
    stream << indent_str;
